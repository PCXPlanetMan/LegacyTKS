...
namespace AssetBundles
{
    ...
    public class AssetBundleLoadAssetOperationSync : AssetBundleLoadAssetOperation
    {
        protected string m_AssetBundleName;
        protected string m_AssetName;
        protected string m_DownloadingError;
        ...
        public AssetBundleLoadAssetOperationSync(string bundleName, string assetName, System.Type type)
        {
            m_AssetBundleName = bundleName;
            m_AssetName = assetName;
            m_Type = type;
        ...
        public override T GetAsset<T>()
        {
            ...
            if (bundle != null)
            {
                var asset = bundle.m_AssetBundle.LoadAsset(m_AssetName, m_Type);
                if (asset != null)
                {
                    return asset as T;
                }
            ...
            {
                Debug.LogError("Get Asset Sync failed, " + m_AssetBundleName);
                return null;
            }
        }
